...
const byte REPLAY_CLOCK_PIN = 5;   //Adjust as required
const byte REPLAY_DATA_PIN = 6;   //Adjust as required
const byte WIFI_MODE_PIN = 7;     //Adjust as required (built-in button on the FireBeetle)
...
const char* AP_SSID = "Toms iPhone";          //Adjust as required
const char* AP_PASSWORD = "13371337";         //Adjust as required
const IPAddress AP_IP(192, 168, 1, 1);       //Adjust as required
